...
const images = [
  {
    src: 'images/1.jpg',
    alt: 'Elite Dacha Sangardak tandir taomlari',
    title: 'Tandir taomlari',
    description: "Tandirda yangi pishgan taomlar va ochiq havodagi mehmon kutish muhiti.",
  },
  {
    src: 'images/2.jpg',
    alt: "Tandir ichida go'sht pishirilmoqda",
    title: 'Tandir kabob',
    description: "Go'sht va ziravorlar tandirda sekin pishib, dasturxonga tayyorlanadi.",
  },
  {
    src: 'images/3.jpg',
    alt: 'Elite Dacha kechki ayvoncha va davra stoli',
    title: 'Kechki ayvoncha',
    description: "Yorug' ayvonda yaqinlar bilan kechki stol atrofida dam olish.",
  },
  {
    src: 'images/4.jpg',
    alt: 'Dacha hovlisidagi stol va stullar',
    title: 'Ochiq havodagi stol',
    description: "Hovli ichida choy, suhbat va sokin dam olish uchun qulay o'tirish joyi.",
  },
  {
    src: 'images/5.jpg',
    alt: 'Elite Dacha Sangardak ochiq hovuzi',
    title: 'Ochiq hovuz',
    description: "Daraxtlar yonidagi basseyn yozgi dam olishga salqin kayfiyat beradi.",
  },
  {
    src: 'images/6.jpg',
    alt: "Daraxtlar orasidagi yopiq yo'lak va dam olish hududi",
    title: "Soyali yo'lak",
    description: "Katta daraxtlar orasidagi sokin yo'lak va tabiiy salqinlik.",
  },
  {
    src: 'images/7.jpg',
    alt: 'Elite Dacha Sangardak uyi va hovlisi',
    title: 'Dacha uyi',
    description: "Mehmonlar uchun ikki qavatli uy, keng hovli va mashina qo'yish joyi.",
  },
  {
    src: 'images/8.jpg',
    alt: "Sangardak tog'lari va ochiq osmon manzarasi",
    title: "Tog' manzarasi",
    description: "Sangardakning keng tog'lari, musaffo osmoni va sokin tabiat nafasi.",
  },
  {
    src: 'images/9.jpg',
    alt: 'Elite Dacha grill va tandir zonasi',
    title: 'Grill va tandir zonasi',
    description: "Kabob, grill va samimiy davralar uchun alohida pishirish hududi.",
  },
  {
    src: 'images/10.jpg',
    alt: 'Sangardak dacha hovuzi daraxtlar soyasida',
    title: 'Soyali hovuz',
    description: "Daraxtlar soyasida salqin basseyn va sokin dam olish muhiti.",
  },
  {
    src: 'images/11.jpg',
    alt: 'Elite Dacha yashil ayvoncha va stol joyi',
    title: 'Yashil ayvoncha',
    description: "Yaproqlar orasidagi shinam stol atrofida suhbat va hordiq.",
  },
]
